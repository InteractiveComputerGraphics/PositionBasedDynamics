...
sliderX1 = add_vector(carX, [1.75, 0.7, 0.5])
sliderX2 = add_vector(carX, [1.75, 0.7, -0.5])
sliderX3 = add_vector(carX, [-1.75, 0.7, 0.5])
sliderX4 = add_vector(carX, [-1.75, 0.7, -0.5])
addSliderJoint(scene, chassis, dBody1, sliderX1, [0, 1, 0])
addSliderJoint(scene, chassis, dBody2, sliderX2, [0, 1, 0])
addSliderJoint(scene, steeringBody, dBody3, sliderX3, [0, 1, 0])
addSliderJoint(scene, steeringBody, dBody4, sliderX4, [0, 1, 0])

sliderY1 = add_vector(carX, [1.75, -0.7, 0.5])
sliderY2 = add_vector(carX, [1.75, -0.7, -0.5])
sliderY3 = add_vector(carX, [-1.75, -0.7, 0.5])
sliderY4 = add_vector(carX, [-1.75, -0.7, -0.5])
addRigidBodySpring(scene, chassis, dBody1, sliderX1, sliderY1, 50000.0)
addRigidBodySpring(scene, chassis, dBody2, sliderX2, sliderY2, 50000.0)
addRigidBodySpring(scene, steeringBody, dBody3, sliderX3, sliderY3, 50000.0)
addRigidBodySpring(scene, steeringBody, dBody4, sliderX4, sliderY4, 50000.0)
